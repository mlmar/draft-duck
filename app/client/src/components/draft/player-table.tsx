...
const stickyRank = 'sticky left-0 z-10 w-16 min-w-16 bg-inherit';
const stickyName = 'sticky left-16 z-10 min-w-40 bg-inherit';
const stickyRankHead = 'sticky left-0 top-0 z-30 w-16 min-w-16 bg-background';
const stickyNameHead = 'sticky left-16 top-0 z-30 min-w-40 bg-background';
            ...
            <Table className='min-w-[56rem]'>
                <TableHeader className='sticky top-0 z-20 bg-background'>
                    <TableRow className='text-muted-foreground hover:bg-transparent'>
                        ...
                        {enabledCats.map((cat) => (
                            <TableHead key={cat} className='bg-background text-right'>
                                {CAT_LABELS[cat]}
                            </TableHead>
                        ))}
                    </TableRow>
